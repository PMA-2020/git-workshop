...
*					Question opinion_action_* dropped
*					Staff options no longer in a group
*					<staff>_here quesiton removed
*					Referral quesiton removed
*					Room Condition question removed
*					fp_bein & year_open reworded (removed month option)
*					fees_posted question removed
*					Question opinion_collected removed
*					sti_services question removed
*					fster_units and mster_units removed
*					iud_supplies "clamp" option removed and "uterine sound" added
*
*******************************************************************************
...
* Mobile Outreach //REVISION BL v17 26Oct2017 option_action_* question dropped
...
* UPDATE BY COUNTRY
*REVISION BL v17 26Oct2017 staff options no longer in a group & <staff>_here question removed
/*
rename doctor_grpdoctor_tot doctor_tot
rename doctor_grpdoctor_here doctor_here
rename midwife_grpmidwife_tot midwife_tot
rename midwife_grpmidwife_here midwife_here
rename auxiliary_grpauxiliary_tot auxiliary_tot
rename auxiliary_grpauxiliary_here auxiliary_here
*rename param_officer_grpparam_officer_t param_officer_tot
*rename param_officer_grpparam_officer_h param_officer_here
rename clinic_officer_grpclinic_officer clinic_officer_tot
rename v57 clinic_officer_here
rename distrib_grpdistrib_tot distrib_tot
rename distrib_grpdistrib_here distrib_here
rename pharmacist_grppharmacist_tot pharmacist_tot
rename pharmacist_grppharmacist_here pharmacist_here
rename staff_other_grpstaff_other_tot other_tot
rename staff_other_grpstaff_other_here other_here
*/
...
*label variable doctor_here "Number of doctors present today"
...
*label variable midwife_here "Number of midwives present today"
...
*label variable auxiliary_here "Number of medical assistants present today"
*label variable param_officer_tot "Total number of paramedics officer"
*label variable param_officer_here "Number of paramedics officer present today"
*label variable clinic_officer_tot "Total number of clinic officers"
*label variable clinic_officer_here "Number of clinic officers here today"
*label variable distrib_tot "Total number of distributors"
*label variable distrib_here "Number of distributors present today"
...
*label variable pharmacist_here "Number of pharmacists present today"
*label variable pharm_tech_tot "Total number of pharm techs"
label variable other_tot "Total number of other medical staff"
*label variable other_here "Number of other medical staff present today"
...
*REVISION BL v17 26Oct2017 referral question removed
/*
...
*REVISION BL v17 26Oct2017 fster_units and mster_units removed
...
* FP Room Conditions 
*REVISION BL v17 26Oct2017 room condition question removed
/*
...
*REVISION BL v17 26Oct2017 removed month from fp_begin & year_open --> reworded
...
* Posted fees
* REVISION BL v17 26Oct2017 fees_posted question removed
/*
...
* Reports of feedback
* REVISION BL v17 26Oct2017 opinions_observed question removed
/*
...
*REVISION BL v17 26Oct2017 opions collected question removed
...
* FP service area
* REVISION BL v17 26Oct2017 room conditions question removed
/*
...
* REVISION BL v17 26Oct2017 referral quesiton removed
/*
...
* REVISION BL v17 26Oct2017 present_24hr fp_today sti_services fp_room_conditions opinions_reported questions removed
...
label variable fp_begin_rwSIF "Month and year began providing FP (SIF)"
...
label variable year_open_rw "Month and year facility opened (string)"
label variable year_open_rwSIF "Month and year facility opened (SIF)"
...
label variable fp_begin_rw "Year began providing FP (string)"
...
capture label var work_begin_rw "When did you begin working at this facility (string)"
capture label var work_begin_rwSIF "When did you begin working at this facility (SIF)"
...
* Drop variables
* REVISION BL v17 26Oct2017 removed services_info fps_info fpr_grp room_grproom_note fp_service_integration_note  client_feedback_note fp_methods_note location_prompt 
* 							added sect_fps_info sect_fp_methods_note sect_fp_service_integration_note sect_end sect_services_info consent_warning this_country
