...
local Listingcsv NER1_Listing_v7
local Listingcsv2 NER1_Listing_v7

local dofiledate 17Jun2015

local GeoID "region department commune quartier EA"
...
global csvdir "~/Dropbox (Gates Institute)/PMADataManagement_`Country'/`Round'/Data/CSV_Files"

**Where you want the datasets to save (DO NOT SAVE ON DROPBOX)
global datadir "~/PMA2020/`Round'/Data"

**Where the do files are saved
global dofiledir "~/Dropbox (Gates Institute)/PMADataManagement_`Country'/`Round'/Cleaning_DoFiles/Current"
...
*REVISION -v2 - Linnea Zimmerman - Nov 2, 2017
